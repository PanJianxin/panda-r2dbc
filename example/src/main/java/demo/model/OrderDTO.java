...
public class OrderDTO {
    ...
    @TableColumn(name = "id", table = "order_item", alias = "itemId")
    private String itemId;

    @TableColumn(name = "order_id", table = "order_item")
    private String orderId;

    @TableColumn(name = "sku_id", table = "order_item")
    private String skuId;

    @TableColumn(name = "name", table = "order_item")
    private String name;

    @TableColumn(name = "main_image", table = "order_item")
    private String mainImage;

    @TableColumn(name = "introduction", table = "order_item")
    private String introduction;

    @TableColumn(name = "specs", isJson = true, table = "order_item")
    private List<Object> specs;

    @TableColumn(name = "price", table = "order_item")
    private BigDecimal price;

    @TableColumn(name = "quantity", table = "order_item")
