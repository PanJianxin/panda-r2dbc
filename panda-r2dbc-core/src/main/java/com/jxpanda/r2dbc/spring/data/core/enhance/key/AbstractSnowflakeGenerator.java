 ...
 * @author Panda
 */
public abstract class AbstractSnowflakeGenerator<T extends Serializable> implements IdGenerator<T> {

    private final Snowflake snowflake;

    protected AbstractSnowflakeGenerator() {
        this(0, 0);
    }

    protected AbstractSnowflakeGenerator(int dataCenterId, int workerId) {
