...
The following table explains how property types of an standardEntity affect mapping:
...
NOTE: Custom top-level standardEntity conversion requires asymmetric types for conversion.
