 ...
 * {@link R2dbcDialect}-specific transformation considering
...
public interface StatementMapper {
    ...
    class SelectSpec {
        ...
        protected SelectSpec(Table table, List<String> projectedFields, List<Expression> selectList,
                             @Nullable CriteriaDefinition criteria, Sort sort, int limit, long offset, boolean distinct, @Nullable LockMode lockMode) {
            this.table = table;
