...
class ParsedSql {
    ...
    /**
     * Set the total count of all the parameters in the SQL statement. Repeated occurrences of the same parameter name
     * do count here.
     */
    ...
    /**
     * Return the total count of all the parameters in the SQL statement. Repeated occurrences of the same parameter
     * name do count here.
     */
